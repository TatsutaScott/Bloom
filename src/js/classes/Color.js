 ...
 * @param {number} alpha - optional param that temporarily changes the alpha value of the color
 */
Color.prototype.setFill = function (context, alpha = 1) {
  context.fillStyle = this.alphaOut(alpha); // sets the fill style of the drawing context to the string output of the color
};
 ...
 * @param {number} alpha - optional param that temporarily changes the alpha value of the color
 */
Color.prototype.setStroke = function (context, alpha = 1) {
  context.strokeStyle = this.alphaOut(alpha); // sets the stroke style of the drawing context to the string output of the color
};
...
/** returns a color string with a different alpha value from the original color
 * @param {number} alpha - the alpha value for the output color string
 * @returns {string} the string to be used by css or html canvas to set color
 */
Color.prototype.alphaOut = function (alpha) {
